...
<script type="text/javascript"
	src="${basePath }/resource/script/user/login/login.js"></script>
<script type="text/javascript"
...
.u_logo {
	background: url("${resourcePath}images/user/login/username.png")
		no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 43px;
...
.p_logo {
	background: url("${resourcePath}images/user/login/password.png")
		no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 12px;
...
.tou {
	background: url("${resourcePath}images/user/login/tou.png") no-repeat;
	width: 97px;
	height: 92px;
	position: absolute;
	top: -87px;
...
.left_hand {
	background: url("${resourcePath}images/user/login/left_hand.png")
		no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
...
.right_hand {
	background: url("${resourcePath}images/user/login/right_hand.png")
		no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
...
.initial_left_hand {
	background: url("${resourcePath}images/user/login/hand.png")
		no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
...
.left_handing {
	background: url("${resourcePath}images/user/login/left-handing.png")
		no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
...
.right_handinging {
	background: url("${resourcePath}images/user/login/right_handing.png")
		no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
			...
			<div
				...
				<P style="margin: 0px 35px 20px 45px;">
					<span style="float: left;"><a
						...
						style="float: right;"><a
						style="color: rgb(204, 204, 204); margin-right: 10px;" href="${basePath }/register/toRegister.html">注册</a>
						<a id="loginButton"
